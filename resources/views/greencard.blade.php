        ...
        <div class="card card-info card-outline card-outline-tabs">
            <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="info-tabs" role="tablist">
                    ...
                    @foreach($prices as $company => $values)
                        <li class="nav-item">
                            <a class="nav-link @if($count === 0) active @endif" id="cashback-tab-{{ $company }}" data-toggle="pill" href="#cashback-content-{{ $company }}" role="tab" aria-controls="tariffs-content" aria-selected="true">Cashback {{ $company }}</a>
                        </li>
                        @php $count ++; @endphp
                    @endforeach
                </ul>
            ...
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                    @php $count = 0; @endphp
                    @foreach($prices as $company => $values)
                        <div class="tab-pane fade show @if($count === 0) active @endif" id="cashback-content-{{ $company }}" role="tabpanel" aria-labelledby="cashback-tab-{{ $company }}">
